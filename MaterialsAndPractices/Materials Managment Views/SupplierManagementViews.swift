...
public extension SupplierSource {
    ...
    var contactSummary: String {
        let person = contactName?.trimmingCharacters(in: .whitespacesAndNewlines) ?? ""
...
public extension SupplierSource {
    ...
    func apply(
        ...
        if let contactPerson { self.contactName = contactPerson }
...
public extension SupplierSource {
    ...
    static func search(_ query: String) -> NSFetchRequest<SupplierSource> {
        ...
        request.predicate = NSCompoundPredicate(orPredicateWithSubpredicates: [
            ...
            NSPredicate(format: "%K CONTAINS[cd] %@", #keyPath(SupplierSource.contactName), q),
